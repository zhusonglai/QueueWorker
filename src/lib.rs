...
#[derive(Debug)]
pub struct QueueWorkerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl QueueWorkerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting QueueWorker processing");
    
    let mut processor = QueueWorkerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = QueueWorkerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = QueueWorkerProcessor::new(false);
